const cardArray = [
  ...
  {
    name: "spacegirl.1",
    img: "img/spacegirl.1.jpg",
  },
  {
    name: "spaceman.1",
    img: "img/spaceman.1.jpg",
  },
  {
    name: "spaceship.1",
    img: "img/spaceship.1.jpg",
  },
  {
    name: "spaceship.2",
    img: "img/spaceship.2.jpg",
  },
  {
    name: "space.1",
    img: "img/space.1.jpg",
...
function creatBoard() {
  for (let i = 0; i < cardArray.length; i++) {
    ...
    card.setAttribute("src", "images/front3.2.jpg");
...
function checkMatch() {
  ...
  if (optionOneId == optionTwoId) {
    cards[optionOneId].setAttribute("src", "images/front3.2.jpg");
    cards[optionTwoId].setAttribute("src", "images/front3.2.jpg");
